    ...
    if(isset($_SESSION['user'])){
        ...
        if($do == 'Manage'){
            ...
            <div class='container'>
                            ...
                            foreach($items as $item){
                                echo "<tr>". 
                                        ...
                                        if(empty($item['avatar'])){
                                            ...
                                            echo "<img src='admin/upload/avatar/" . $item['avatar'] ."' alt=''>";
                                        } 
                                        echo "</td><td>" . $item['Name'] . 
                                           ...
                                           "<td>" . $item['FullName'] .
                                           "<td>" . 
                                                  "<a href='dashboard.php?do=Edit&itemid=" . $item['Item_ID'] . "' 
                                                      class='btn btn-success'><i class='fa fa-edit'></i> Edit</a>". 
                                                  "<a href='dashboard.php?do=Delete&itemid=" . $item['Item_ID'] . "' 
                                                      class='btn btn-danger confirm'>
                                                      <i class='fa fa-close'></i> Delete</a>";
                                                    if($item['status'] == 1){
                                                    echo "<a href='dashboard.php?do=Status&itemid=" . $item['Item_ID'] . "' 
                ...
                <a href="dashboard.php?do=Add" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add New</a>
            </div>
